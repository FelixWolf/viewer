...
const U64 LSCRIPTStateBitField[LSTT_EOF] =
{
    ...
    0x0000004000000000LL,   // LSTT_LINKSET_DATA
    0x0000008000000000LL,   // LSTT_GAME_CONTROL
    0x0000010000000000LL,   // LSTT_ON_DEATH
    0x0000020000000000LL,   // LSTT_ON_DAMAGE
    0x0000040000000000LL    // LSTT_FINAL_DAMAGE
};
